...
INSERT INTO dishes (name, description, user_id, cuisine_id, img_url, price, type, timeframe) VALUES('Tomato Upma', 'a tangy and spicy upma made with sooji-rave cream of wheat, tomatoes and spices.', 7, 4, 'https://www.vegrecipesofindia.com/wp-content/uploads/2016/01/tomato-upma-recipe-2.jpg', 5.73, 'pick-up', '11:00 - 1:00'),
...
('Taramasalata', 'This creamy blend of pink or white fish roe, with either a potato or bread base, is best with a drizzle of virgin olive oil or a squeeze of lemon.', 6, 5, 'https://www.bbcgoodfood.com/sites/default/files/editor_files/2018/08/taramasalata.jpg', 7.99, 'pick-up','12:00 - 2:00'),
('Moussaka', 'Variations on moussaka are found throughout the Mediterranean and the Balkans.', 5, 5, 'https://www.bbcgoodfood.com/sites/default/files/editor_files/2018/08/moussaka.jpg', 7.89, 'sit-down','7:00'),
('Grilled meat', 'Greece’s favourite fast food, served on chopped tomatoes and onions in pitta bread with lashings of tzatziki.', 7, 5, 'https://www.bbcgoodfood.com/sites/default/files/editor_files/2018/08/grilled-lamb.jpg', 6.89,' sit-down','6:30'),
...
INSERT INTO dishes (name, description, user_id, cuisine_id, img_url, price, type, timeframe) VALUES ('Inside-out chicken Kiev', 'Place the chicken on a baking tray, rub with a little of the butter, season and cook under the grill for 15 mins, turning once until cooked through.', 7, 6, 'https://www.bbcgoodfood.com/sites/default/files/styles/recipe/public/user-collections/my-colelction-image/2015/12/recipe-image-legacy-id--520471_11.jpg?itok=6JxupEw4', 9.73, 'pick-up', '1:00 - 2:00'),
...
('5-ingredient falafel', 'Make falafel with just a handful of storecupboard ingredients. To give the falafels a better texture, be sure to use dried chickpeas rather than canned', 6, 10, 'https://www.bbcgoodfood.com/sites/default/files/styles/recipe/public/recipe/recipe-image/2018/08/falafel.jpg?itok=kESclYaT', 4.98,'pick-up', '12:00 - 2:00');

INSERT INTO dishes (name, description, user_id, cuisine_id, img_url, price, type, timeframe) VALUES('Bengali mustard fish', 'A simple seafood curry of white fish, tomatoes and whole green chillies that is deliciously spicy, healthy and quick enough for every day', 7, 14, 'https://www.bbcgoodfood.com/sites/default/files/styles/recipe/public/recipe_images/bengali-mustard-fish_0.jpg?itok=KfunH1Zb', 5.73, 'sit-down', '1:00'),
