...
//
//   db.one(
//     "SELECT DISTINCT d.*, u.first_name, u.ispickup, u.last_name, u.profile_pic, u.building_number, u.address, u.zip_code  FROM dishes AS d FULL JOIN users AS u ON d.user_id = u.id WHERE d.id=$1 GROUP BY u.id, d.id",
//     [dish_id]
//   )
//     .then(dish => {
//       res.status(200).json({
